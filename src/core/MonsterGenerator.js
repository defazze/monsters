...
export default class {
  ...
  getCoordinates(number) {
    ...
    switch (number) {
      ...
      case 3:
        return { x: CELL_SIZE * 7, y: CELL_SIZE * 7 };
      case 4:
        return { x: CELL_SIZE * 7, y: CELL_SIZE * 2 };
      case 5:
        return { x: CELL_SIZE * 7, y: CELL_SIZE * 8 };
      case 6:
        return { x: CELL_SIZE * 8, y: CELL_SIZE * 4 };
      case 7:
        return { x: CELL_SIZE * 8, y: CELL_SIZE * 6 };
      case 8:
        return { x: CELL_SIZE * 9, y: CELL_SIZE * 5 };
    }
  }
}
